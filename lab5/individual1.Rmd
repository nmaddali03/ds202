...
**Based off the map, Chevy seems like the most dangerous car. As you move across the map right to left the cars change from ford to Chevy. I am defining the dangerous cars as the most common vehicle in a crash in the state.**
...
**The graph I've created has three rows of graphs. The rows are data for both men and women, men, and then women. The columns of graphs are ordered by days of the week. The x-axis is the hour of day and the y-axis is the total number of accidents. Men, evidently, get into more accidents than women. It seems like the most accidents occur in the weekends. But in general, most accidents occur at night.**
...
**The most deaths, shown by the green dots on the map, seem to occur on the east cost.**
...
**The plots show that winter is more dangerous and more accidents happen throughout the states. Texas and California seem to have the most accidents no matter where in summer or winter.**