...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **Neha Maddali**. I am a sophomore studying *Computer Science* with a minor in Data Science. I'm from Carpentersville, IL and am excited to have in person classes again!
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: Data scientists and machine learning engineers are some jobs that I think are growing in the technology industry. Data scientists typically design data modeling processes to create algorithms and predictive models and persom custom analysis. While machine learning engineers create data funnels and deliver software solutions. 
    
    Here is a link to an image: https://www.proschoolonline.com/wp-content/uploads/2018/12/data-scientist-musthave-skills-1.jpg
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I'm not quite sure yet, I have to explore different data sets and topics that a lot of data has been collected on for. 
...
9. Configure your git username and user email by modifying and entering the following commands into the terminal
    ...
    Answer: Done?
    Yes. (used Neha Maddali, nmaddali@iastate.edu)
